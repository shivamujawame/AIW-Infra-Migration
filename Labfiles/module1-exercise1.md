...
9. Go to **Start** button in the VM, search for **Hyper-V Manager** there and select it. 
   ...
   You can also open the **Hyper-V manager** by clicking on the icon 
   <img src="Images/Icon-hyperv.png" style="width:0.28129in;height:0.36463in" /> 
   that is present in the taskbar. 
