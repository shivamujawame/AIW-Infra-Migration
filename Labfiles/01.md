...
7. Select an image definition or select create new and provide a name and information for a new Image definition.
...
11. Open the image gallery which created in previous step.

12. On the page for the image gallery, on the upper menu, select +VMSS.

   ![](Images/vmss.png)

13. Enter the Virtual Machine name scale set name.

   ![](Images/vmname.png)

14. Select any size.

15. Select the License type as Window server.
