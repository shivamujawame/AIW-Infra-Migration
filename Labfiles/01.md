...
24. On the **Add discovery source** blade, provide the following details:
    ...
    ![Screenshot of the Azure Migrate appliance configuration wizard, showing the 'Add discovery source' panel.](https://github.com/CloudLabs-MCW/MCW-Line-of-business-application-migration/blob/stage-1/Hands-on%20lab/Images/discoverysource-2.png?raw=true "Discovery source - SmartHotelHost")
