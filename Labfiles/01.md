...
24. On the **Add discovery source** blade, provide the following details:
    ...
    ![Screenshot of the Azure Migrate appliance configuration wizard, showing the 'Add discovery source' panel.](Images/discoverysource-2.png?raw=true "Discovery source - SmartHotelHost")
